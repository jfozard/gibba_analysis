...
#        maxproj(output_dir+'cropped_stacks/'+n+'.tif', output_dir+'maxproj/'+n+'.png')
        ...
        f.write('<td><a href="{}maxproj/'.format(fn2)+n+'.png"><img src="{}maxproj/'.format(fn2)+n+'-thumb.png" height="200px"></a></td>')
        f.write('<td><a href="{}image_labels/'.format(fn)+n+'.png"><img src="{}image_labels/'.format(fn)+n+'-thumb.png" height="200px"></a></td>')
        f.write('<td><a href="{}image_relarea/'.format(fn)+n+'.png"><img src="{}image_relarea/'.format(fn)+n+'-thumb.png" height="200px"></a></td>')
        f.write('<td><a href="{}image_abslogarea/'.format(fn)+n+'.png"><img src="{}image_abslogarea/'.format(fn)+n+'-thumb.png" height="200px"></a></td>')
        f.write('<td><a href="{}image_aniso/'.format(fn)+n+'.png"><img src="{}image_aniso/'.format(fn)+n+'-thumb.png" height="200px"></a></td>')
        f.write('</tr>\n')
