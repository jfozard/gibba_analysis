...
def bladder_report(output_filename, name, input_ply, input_csv):
    ...
    f.write('<td><a href="../hc_image_labels/'+name+'.png"><img src="../hc_image_labels/'+name+'-thumb.png" height="200px"></a></td>')
    f.write('<td><a href="../hc_image_relarea/'+name+'.png"><img src="../hc_image_relarea/'+name+'-thumb.png" height="200px"></a></td>')
    f.write('<td><a href="../hc_image_abslogarea/'+name+'.png"><img src="../hc_image_abslogarea/'+name+'-thumb.png" height="200px"></a></td>')
    f.write('<td><a href="../hc_image_aniso/'+name+'.png"><img src="../hc_image_aniso/'+name+'-thumb.png" height="200px"></a></td>')
    f.write('</tr>\n')
    f.write('</table>\n')
